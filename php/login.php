            ...
            <div class="user_card">
                <div class="d-flex justify-content-center">
                    <div class="brand_logo_container">
                        <img src="images/Screenshot (31).png" class="brand_logo" alt="Logo">
                    </div>
                </div>
                <div class="d-flex justify-content-center form_container">
                    <form action="loginVal.php" method="POST">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="email" id="logEmail" class="form-control input_user" value="" placeholder="email">
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fas fa-key icon"></i></span>
                            </div>
                            <input type="password" name="pass" id="logPass" class="form-control input_pass" value="" placeholder="password">
                        </div>
                        ...
                        <div class="d-flex justify-content-center mt-3 login_container">
                            <button type="submit" name="Login" class="btn login_btn" onclick="Revert()">Login</button>
                        </div>
                    </form>
                </div>
